...
<body>
  ...
  <div class="section-sub">Manage your personal and internship information</div>
 
  <div class="profile-hero">
    <div class="profile-avatar">
        <i class='bx bx-user-circle' style="font-size:80px;color:var(--text-muted);"></i>
    </div>
    <div class="profile-info">
      <p> User &nbsp;•&nbsp; IT Student Intern &nbsp;•&nbsp; Universiti Teknologi MARA</p>
      <div class="profile-social">
        <div class="social-btn">in LinkedIn</div>
  ...
  <div class="info-grid">
    <div class="info-card">
      <div style="font-size:13px;font-weight:600;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.5px;margin-bottom:12px">Personal Information</div>
      <div class="info-row"><span class="info-label">Student ID</span><span class="info-value">2022123456</span></div>
      <div class="info-row"><span class="info-label">University</span><span class="info-value">Universiti Teknologi MARA</span></div>
      <div class="info-row"><span class="info-label">Faculty</span><span class="info-value">Information Science</span></div>
      <div class="info-row"><span class="info-label">Programme</span><span class="info-value">Bachelor of Information Management Systems</span></div>
      <div class="info-row"><span class="info-label">Email</span><span class="info-value">user@uitm.edu.my</span></div>
      <div class="info-row"><span class="info-label">Phone</span><span class="info-value">+60 11-1234 5678</span></div>
    </div>
    <div class="info-card">
      <div style="font-size:13px;font-weight:600;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.5px;margin-bottom:12px">Internship Information</div>
      <div class="info-row"><span class="info-label">Company</span><span class="info-value">Petronas Digital Sdn. Bhd.</span></div>
      <div class="info-row"><span class="info-label">Position</span><span class="info-value">UI/UX Designer Intern</span></div>
      <div class="info-row"><span class="info-label">Supervisor</span><span class="info-value">Encik Faiz Hassan</span></div>
      <div class="info-row"><span class="info-label">Start Date</span><span class="info-value">10 February 2025</span></div>
      <div class="info-row"><span class="info-label">End Date</span><span class="info-value">10 August 2025</span></div>
      <div class="info-row"><span class="info-label">Mode</span><span class="info-value">Hybrid</span></div>
    </div>
  </div>
</div>    
